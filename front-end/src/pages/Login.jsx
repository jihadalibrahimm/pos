...
function Login() {
    ...
    return (
        <div className='min-h-screen bg-linear-to-b from-[#faf6ef] to-[#f0e5d2] flex items-center justify-center p-6 mt-6 '> 
            <motion.div initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.7}}
                ...
                rounded-3xl shadow-2xl p-7">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <h1 className="text-3xl text-neutral-900 font-bold"> Login to Your Account </h1>
